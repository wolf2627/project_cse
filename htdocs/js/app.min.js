function loadAssignRoleForms(){var e=document.getElementById("assign-roles-operation").value;let t=document.getElementById("assign-roles-dynamic-form");t.innerHTML="","assign"===e?(console.log("assign clicked"),fetch("/api/app/template/assignrole/type?operation=assign").then(e=>e.text()).then(e=>{t.innerHTML=e}).catch(e=>{console.error("Error:",e),t.innerHTML='<div class="alert alert-danger">An error occurred.</div>'})):"unassign"===e&&fetch("/api/app/template/unassignrole?operation=unassign").then(e=>e.text()).then(e=>{t.innerHTML=e}).catch(e=>{console.error("Error:",e),t.innerHTML='<div class="alert alert-danger">An error occurred.</div>'})}function loadAssignRoleForms2(){var e=document.getElementById("AssignRole-UserType").value;let t=document.getElementById("assign-roles-other-fields-dynamic-form");t.innerHTML="",fetch("/api/app/template/assignrole/otherfields?category="+e).then(e=>e.text()).then(e=>{t.innerHTML=e}).catch(e=>{console.error("Error:",e),t.innerHTML='<div class="alert alert-danger">An error occurred.</div>'})}function setCookie(e,t,o){var n,s="";o&&((n=new Date).setTime(n.getTime()+24*o*60*60*1e3),s="; expires="+n.toUTCString()),document.cookie=e+"="+t+s+"; path=/"}function loadRolesForm(){var e=document.getElementById("manage-roles-operation").value;let t=document.getElementById("manage-roles-dynamic-form");t.innerHTML="","create"===e?fetch("/api/app/template/createrole?operation=create").then(e=>e.text()).then(e=>{t.innerHTML=e}).catch(e=>{console.error("Error:",e),t.innerHTML='<div class="alert alert-danger">An error occurred.</div>'}):"update"===e?fetch("/api/app/template/updaterole?operation=update").then(e=>e.text()).then(e=>{t.innerHTML=e}).catch(e=>{console.error("Error:",e),t.innerHTML='<div class="alert alert-danger">An error occurred.</div>'}):"delete"===e&&fetch("/api/app/template/deleterole?operation=delete").then(e=>e.text()).then(e=>{t.innerHTML=e}).catch(e=>{console.error("Error:",e),t.innerHTML='<div class="alert alert-danger">An error occurred.</div>'})}function manageRoleSubmitForm(e){var t=new FormData;let o;"create"===e?(t.append("roleName",document.getElementById("roleName").value),t.append("roleCategory",document.getElementById("roleCategory").value),t.append("description",document.getElementById("description").value),o="/api/app/role/create"):"update"===e?(t.append("roleId",document.getElementById("roleId").value),t.append("roleName",document.getElementById("roleName").value),t.append("description",document.getElementById("description").value),o="/api/app/role/update"):"delete"===e&&(t.append("roleId",document.getElementById("roleId").value),o="/api/app/role/delete"),fetch(o,{method:"POST",body:t}).then(e=>e.json()).then(e=>{document.getElementById("result");(e.success?new Toast("Success","now",e.message):new Toast("Failure","now",e.message)).show(),loadRolesForm()}).catch(e=>{console.error("Error:",e),new Toast("Error","now","An error occurred.").show(),loadRolesForm()})}function fetchNewKural(){fetch("/api/app/addons/thirukkural").then(e=>e.json()).then(e=>{$("#line1").text(e.Line1),$("#line2").text(e.Line2),$("#kural-container").attr("data-bs-content",`
            ...
            `;s.prepend(e)}function d(){n[0].reset()}$(n).on("submit",function(e){e.preventDefault();let t=document.getElementById("permission_name").value,o=document.getElementById("description").value,n=document.getElementById("permission_category").value,s={permission_name:t,description:o,permission_category:n};var a;l?(s.permission_id=c||null,(a=new Dialog("Update Permission",'<div style="font-size: 16px; line-height: 1.6;"><strong>Are you sure you want to update the permission as below?</strong><br><br><strong>Permission Name:</strong> '+t+"<br><strong>Description:</strong> "+o+"<br><strong>Permission Category:</strong> "+n+"<br></div>")).setButtons([{name:"Update",class:"btn-primary",onClick:function(e){$.ajax({url:r+"/update",method:"POST",data:s,success:function(e){new Toast("now","success",e.message).show();e={permission_name:t,description:o,permission_category:n,permission_id:e.permission_id};console.log(e),i(e),d(),$('#permissionForm button[type="submit"]').text("Create"),l=!1,c=null,$("#cancelPermission").remove()},error:function(e){let t="An error occurred";t=409===e.status?"No changes Made.":500===e.status?"Please try again later.":e.responseJSON?.message||"Unknown error occurred.",new Toast("now","error",t).show(),console.error("Error creating permission:",e),d(),$('#permissionForm button[type="submit"]').text("Create"),l=!1,c=null,$("#cancelPermission").remove()}}),$(e.data.modal).modal("hide")}},{name:"Cancel",class:"btn-secondary",onClick:function(e){d(),$('#permissionForm button[type="submit"]').text("Create"),l=!1,c=null,$("#cancelPermission").remove(),$(e.data.modal).modal("hide")}}])):(a=new Dialog("Create Permission",'<div style="font-size: 16px; line-height: 1.6;"><strong>Are you sure you want to create the permission below?</strong><br><br><strong>Permission Name:</strong> '+t+"<br><strong>Description:</strong> "+o+"<br><strong>Permission Category:</strong> "+n+"<br></div>")).setButtons([{name:"Create",class:"btn-primary",onClick:function(e){$.ajax({url:r+"/create",method:"POST",data:s,success:function(e){new Toast("now","success",e.message).show();e={permission_name:t,description:o,permission_category:n,permission_id:e.permissionId};i(e)},error:function(e){let t="An error occurred";t=409===e.status?"The permission already exists.":500===e.status?"Please try again later.":e.responseJSON?.message||"Unknown error occurred.",new Toast("now","error",t).show(),console.error("Error creating permission:",e)}}),d(),$(e.data.modal).modal("hide")}},{name:"Cancel",class:"btn-secondary",onClick:function(e){d(),$(e.data.modal).modal("hide")}}]),a.show()}),$(document).on("click",".editPermission",function(){var t,e=$(this).data("id"),e=($(this).data("name"),t=e),o=function(e){console.log("permission_name: "+e.permission_name),console.log("description: "+e.description),$("#permission_name").val(e.permission_name),$("#description").val(e.description),$("#permission_category").val(e.permission_category),l=!0,c=t,$('#permissionForm button[type="submit"]').text("Update"),$("#cancelPermission").length||$("#permissionForm").append('<button type="button" class="btn btn-secondary" id="cancelPermission" style="display:inline-block">Cancel</button>'),$("html, body").animate({scrollTop:n.offset().top},500)};e={permission_id:t},$.ajax({url:"/api/app/permission/get/by/id",method:"POST",data:e,success:function(e){console.log(e),o({permission_name:e.permission_name,description:e.description,permission_category:e.permission_category})},error:function(){new Toast("now","error","An error occurred").show()}})}),$(document).on("click","#cancelPermission",function(){console.log("Cancel button clicked"),d(),$('#permissionForm button[type="submit"]').text("Create"),l=!1,c=null,$("#cancelPermission").remove()}),$(document).on("click",".deletePermission",function(){var e=$(this).data("id"),t=$(this).data("name"),o=e,e=t;(e=new Dialog("Delete Permission","Are you sure you want to delete the permission "+e+"?")).setButtons([{name:"Delete",class:"btn-danger",onClick:function(e){var t;$.ajax({url:r+"/delete",method:"POST",data:{permission_id:o},success:function(){new Toast("now","success","Permission deleted successfully").show()},error:function(e,t,o){console.error("Error deleting permission"),new Toast("now","error","An error occurred").show()}}),t=o,s.find(`tr[data-id="${t}"]`).remove(),$(e.data.modal).modal("hide")}},{name:"Cancel",class:"btn-secondary",onClick:function(e){$(e.data.modal).modal("hide")}}]),e.show()})}),$("#markAttendance-container").ready(function(){console.log("markAttendance-container ready"),$("#classSelect-att").on("change",function(){$("#submitAttendanceBtn").show();var e,t=$("#classSelect-att").val(),o=(console.log("classId: "+t),$("#classSelect-att option:selected").data("section")),n=$("#classSelect-att option:selected").data("subject"),s=$("#classSelect-att option:selected").data("batch"),a=$("#classSelect-att option:selected").data("semester"),r=$("#classSelect-att option:selected").data("date"),l=$("#classSelect-att option:selected").data("day"),c=$("#classSelect-att option:selected").data("timeslot"),i=$("#classSelect-att option:selected").data("department");null==t||null==o||null==n||null==s||null==a||null==r||null==l||null==c?($("#attendanceAlert").show(),$("#attendanceTemplate").html(""),$("#submitAttendanceBtn").hide()):(console.log("section: "+o),console.log("subject: "+n),console.log("batch: "+s),console.log("semester: "+a),console.log("date: "+r),console.log("day: "+l),console.log("timeslot: "+c),console.log("department: "+i),(e=new FormData).append("classId",t),e.append("section",o),e.append("department",i),e.append("subjectCode",n),e.append("batch",s),e.append("semester",a),e.append("date",r),e.append("day",l),e.append("timeslot",c),$("#attendanceAlert").hide(),console.log("classSelect-att changed"),$.ajax({url:"/api/app/template/attendance/studentslist",type:"POST",data:e,contentType:!1,processData:!1,success:function(e){console.log("response: "+e),$("#attendanceTemplate").html(e),$("#submitAttendanceBtn").show()},error:function(e){console.log("response: "+e)}}))}),$("#submitAttendanceBtn").on("click",function(e){console.log("submitAttendanceBtn clicked"),e.preventDefault();var n,o,s,t,a,r,l=$("#facultyId-markatt").val(),e=$("#classSelect-att").val(),c=$("#classSelect-att option:selected").data("section"),i=$("#classSelect-att option:selected").data("subject"),d=$("#classSelect-att option:selected").data("department"),u=$("#classSelect-att option:selected").data("batch"),p=$("#classSelect-att option:selected").data("semester"),m=$("#classSelect-att option:selected").data("date"),g=$("#classSelect-att option:selected").data("day"),h=$("#classSelect-att option:selected").data("timeslot");console.log("classId:",e),console.log("section:",c),console.log("subject:",i),console.log("batch:",u),console.log("semester:",p),console.log("date:",m),console.log("day:",g),console.log("timeslot:",h),(e?(n=[],$("#attendanceTemplate tbody tr").each(function(){var e=$(this).find("td:eq(2)").text().trim(),t=(console.log("studentName:",e),$(this).find("td:eq(1)").text().trim()),o=$(this).find('input[type="radio"]:checked').val();t&&o&&n.push({name:e,id:t,status:o})}),console.log("attendanceData:",n),o=[],s=[],t=[],n.forEach(function(e){"absent"===e.status?o.push(e.id):"on-duty"===e.status?s.push(e.id):"present"===e.status&&t.push(e.id)}),e=o.length,a=s.length,r=t.length,(r=new Dialog("Attendance","<div><p><strong>Total Students Count:</strong> "+(e+a+r)+"</p><p><strong>Present Students Count:</strong> "+r+"</p><p><strong>Absent Students Count:</strong> "+e+"</p>"+(0<e?'<div class="table-responsive"><table class="table table-bordered"><thead><tr><th>S.No</th><th>Student Name</th><th>Reg No</th><th>Status</th></tr></thead><tbody>'+o.map(function(t,e){return"<tr><td>"+(e+1)+"</td><td>"+n.find(e=>e.id===t).name+"</td><td>"+t+"</td><td>Absent</td></tr>"}).join("")+"</tbody></table>":"")+"</div><p><strong>On Duty Students Count:</strong> "+a+"</p>"+(0<a?'<div class="table-responsive"><table class="table table-bordered"><thead><tr><th>S.No</th><th>Student Name</th><th>Student ID</th><th>Status</th></tr></thead><tbody>'+s.map(function(t,e){return"<tr><td>"+(e+1)+"</td><td>"+n.find(e=>e.id===t).name+"</td><td>"+t+"</td><td>On Duty</td></tr>"}).join("")+"</tbody></table>":"")+"</div></div>")).setButtons([{name:"Mark Attendance",class:"btn-success",onClick:function(e){var t;console.log("Marking attendance"),console.log("absentStudents:",o),console.log("onDutyStudents:",s),0===n.length?alert("Please mark attendance for at least one student."):((t=new FormData).append("department",d),t.append("facultyId",l),t.append("date",m),t.append("day",g),t.append("subjectCode",i),t.append("section",c),t.append("timeslot",h),t.append("batch",u),t.append("semester",p),t.append("attendanceData",JSON.stringify(n)),console.log("Form data prepared."),$.ajax({url:"/api/app/attendance/save",type:"POST",data:t,contentType:!1,processData:!1,success:function(e){console.log("Response:",e),localStorage.setItem("toastData",JSON.stringify({title:"Success",message:"Attendance marked successfully",type:"success"})),location.reload()},error:function(e,t,o){console.error("Error:",o),console.error("Response:",e.responseText);o=JSON.parse(e.responseText);console.log(JSON.stringify({message:o.message})),localStorage.setItem("toastData",JSON.stringify({title:"Failed",message:o.message,type:"error"})),location.reload()}}),$(e.data.modal).modal("hide"))}},{name:"Cancel",class:"btn-danger",onClick:function(e){console.log("Attendance marking cancelled"),$(e.data.modal).modal("hide")}}]),r):new Toast("Error","now","Please select a class to mark attendance")).show()})}),$(document).ready(function(){var e=localStorage.getItem("toastData");e&&(e=JSON.parse(e),new Toast(e.title,"now",e.message).show(),localStorage.removeItem("toastData"))}),$(document).ready(function(){$("#student-select").on("change",function(){var e=this.options[this.selectedIndex],t=e.dataset.regno,o=e.dataset.name,e=e.dataset.marks;$("#reg-no").val(t),$("#student-name").val(o),$("#current-marks").val(e),$("#update-form").removeClass("d-none")}),$("#reset-btn").on("click",function(){$("#student-select").val(""),$("#update-form").addClass("d-none")}),$("#update-btn").on("click",function(){var e=$("#reg-no").val(),o=$("#updated-marks").val(),n=$("#update-form"),s=n.data("batch"),a=n.data("semester"),r=n.data("subject_code"),l=n.data("testname"),c=n.data("section"),n=n.data("department");if(console.log(e,o,s,a,r,l,c,n),o.trim()){(updatingToast=new Toast("Updating","now","Updating marks")).show();let t=new FormData;t.append("reg_no",e),t.append("new_mark",o),t.append("batch",s),t.append("semester",a),t.append("subject_code",r),t.append("testname",l),t.append("section",c),t.append("department",n);e=new Dialog("Update Marks","Are you sure to update mark as "+o+"?");e.setButtons([{name:"Update Mark",class:"btn-success",onClick:function(e){$.ajax({url:"/api/app/update/updatemark",type:"POST",data:t,processData:!1,contentType:!1,success:function(e){console.log("Marks updated successfully:",e),new Toast("Success","now","Marks updated successfully").show(),$("#update-form").find("input").val(""),$("#student-select").val("").trigger("change"),$("#update-form").addClass("d-none")},error:function(e){console.error("Error updating marks:",e),(errortoast=new Toast("Failed","now","Marks not updated")).show()}}),$(e.data.modal).modal("hide")}},{name:"Cancel",class:"btn-secondary",onClick:function(e){new Toast("Cancelled","now","Update Marks Cancelled").show(),$(e.data.modal).modal("hide")}}]),e.show()}else alert("Please enter new marks.")}),$("#back-btn").on("click",function(){window.history.back()}),$("#edit-back-btn").on("click",function(){window.history.back()})}),Array.from(document.querySelectorAll('[data-bs-toggle="tooltip"]')).forEach(e=>{new bootstrap.Tooltip(e)}),$(document).ready(function(){let t=$(".sidebar-cus"),o=$(".sidebar-expand"),n=$(".sidebar-overlay");o.click(function(){t.toggleClass("visible"),n.toggleClass("visible")}),$(document).click(function(e){t.is(e.target)||t.has(e.target).length||o.is(e.target)||o.has(e.target).length||(t.removeClass("visible"),n.removeClass("visible"))}),t.click(function(e){e.stopPropagation()}),o.click(function(e){e.stopPropagation()})}),$(document).ready(function(){console.log("Role Permission Manage JS Loaded [updated]");let a=[],r=[];async function t(e=""){return console.log("Loading Permissions"),$("#permissions-container").empty(),a=[],$.ajax({url:"/api/app/permission/get/all",method:"POST",data:{search:e},success:function(e){a=e.map(e=>({id:e._id.$oid,name:e.permission_name,category:e.permission_category,description:e.description})),console.log("Permissions Data Loaded:",a)},error:function(e){console.error("Error fetching permissions:",e)}})}function o(){console.log("Generating Permissions UI");let o=r.map(e=>e.id);var e,t=a.reduce((e,t)=>(e[t.category]=e[t.category]||[],e[t.category].push(t),e),{}),n=$("#permissions-container");for(e in n.empty(),t){var s=t[e],s=`
                ...
                `,e=new Dialog("User Details",n);e.setButtons([{name:"Confirm",class:"btn-success",onClick:function(e){$("#user-info").html(t),r(a,s),console.log("Enabling Submit Button"),$("#user-role-submit").removeClass("d-none"),$("#user-role-submit").addClass("d-block"),$(e.data.modal).modal("hide")}},{name:"Cancel",class:"btn-secondary",onClick:function(e){c(),$(e.data.modal).modal("hide")}}]),e.show()}}).catch(e=>{console.error("Fetch error:",e)})}else console.error("User ID/Registration No cannot be empty.");else console.error("Please select a category first.")}),$("#user-role-submit").on("click",function(e){console.log("User Role Submit Button Clicked");let o=$("#user-role-category").val(),n=$("#role-user-id").val();if(o)if(n){var s=$("input[name='role[]']:checked").map(function(){return $(this).val()}).get();0===s.length&&(console.error("No roles selected."),s=[]),console.log("Selected Category:",o),console.log("Selected User ID:",n),console.log("Selected Roles:",s);let t=new FormData;t.append("category",o),t.append("user_id",n),s.forEach(e=>{t.append("roles_id[]",e)}),console.log("Submitting form data:",t),$.ajax({url:"/api/app/role/set",method:"POST",contentType:!1,processData:!1,data:t,success:function(e){e&&e.message&&0!==e.message.length?(console.log("Roles assigned successfully:",e),l("Success","Roles assigned successfully!"),Array.isArray(e.result)&&0<e.result.length?(e=e.result.map(function(e){return e.name}),(e=new Dialog("Success",`<h6>Current Roles for User: ${$("#role-user-id").val()} </h6>
                        <ul>
                        ...
                        <p>No Roles Assigned</p>`)).setButtons([{name:"Close",class:"btn-secondary",onClick:function(e){$(e.data.modal).modal("hide")}}]),e.show())):l("Success","No roles assigned")},error:function(e,t,o){console.error("Error assigning roles:",o),l("Error","Failed to assign roles. Please try again.")}})}else console.error("User ID/Registration No cannot be empty.");else console.error("Please select a category first.")})}),$(document).ready(function(){console.log("viewattendance.js loaded edited");let s=$("#session-select"),a=[],r="";function l(t){var e=a.find(e=>e.session._id===t);if(e){let t=$("#attendance-table");t.empty(),e.attendance.forEach(e=>{t.append(`
        ...
        `);$(document).on("change","#attendanceDate",function(){var e=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][new Date($(this).val()).getDay()];$("#selectedDay").text("Selected Day: "+e)}),e.setButtons([{name:"View Attendance",class:"btn-success",onClick:function(e){var t=$("#attendanceDate").val(),o=(console.log("Date:",t),new FormData);o.append("faculty_id",n),o.append("class_id",r),o.append("date",t),$.ajax({url:"/api/app/attendance/get/attendance",type:"POST",data:o,processData:!1,contentType:!1,success:function(e){console.log("Attendance Data:",e),(a=e.message).forEach(e=>{s.append(new Option(e.session.day+" "+e.session.timeslot,e.session._id))}),0<a.length&&l(a[0].session._id)},error:function(e,t,o){console.error("Error:",o),console.error("Response:",e.responseText);o=JSON.parse(e.responseText);console.log(JSON.stringify({message:o.message})),localStorage.setItem("toastData",JSON.stringify({title:"Failed",message:o.message,type:"error"})),location.reload()}}),$(e.data.modal).modal("hide")}},{name:"Cancel",class:"btn-secondary",onClick:function(e){new Toast("Cancelled","now","View Attendance Cancelled").show(),$(e.data.modal).modal("hide"),location.reload()}}]),e.show()}),s.change(function(){l(this.value)}),$("#edit-all").click(function(){$(".read-only").hide(),$(".edit-mode").show(),$(this).hide(),$("#save-all").show()}),$("#save-all").click(function(){var e=s.val();let o=[];document.querySelectorAll("#attendance-table tr").forEach(e=>{var t=e.dataset.studentId,e=e.querySelector(".edit-mode").value;o.push({id:t,status:e})});var t=new FormData;t.append("sessionId",e),t.append("attendanceData",JSON.stringify(o)),t.append("classId",r),t.append("edit",!0),console.log("Session ID:",e),console.log("Updates:",o),console.log("Class ID:",r),$.ajax({url:"/api/app/attendance/saveedit",method:"POST",data:t,processData:!1,contentType:!1,success:function(){alert("Attendance updated successfully"),location.reload()},error:function(e){console.error("Error saving attendance:",e.responseText),alert("Failed to save attendance.")}})})});
