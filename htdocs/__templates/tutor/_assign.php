<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="text-center mb-4">Assign Tutor</h1>
            <form id="assign-tutor-form">
                ...
                <!-- Section -->
                <div class="form-group row mb-3">
                    <label for="assign-section" class="col-sm-3 col-form-label">Section</label>
                    <div class="col-sm-9">
                        <select class="form-control" id="assign-section" name="section" required>
                ...
                <div class="text-center">
                    <button type="submit" id="assign-tutor-btn" class="btn btn-primary btn-lg px-5">Assign</button>
                </div>
            </form>
        </div>
    </div>
