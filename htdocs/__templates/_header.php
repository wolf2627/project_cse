        ...
        <div class="d-flex align-items-center">
            ...
            <div id="banner-text">
                <a href="/dashboard" class="text-decoration-none text-body">
                    <p class="mb-0 me-3 fs-5 text-truncate">PSNA College of Engineering and Technology</p>
                </a>
            </div>
        </div>
