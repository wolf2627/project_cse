...
<div class="container mt-5">
    ...
    <!-- Select Operation -->
    <div class="mb-4">
        <label for="manage-roles-operation" class="form-label">Select Operation:</label>
        <select id="manage-roles-operation" class="form-select" onchange="loadRolesForm()">
    ...
    <!-- Dynamic Form -->
    <div id="manage-roles-dynamic-form">
