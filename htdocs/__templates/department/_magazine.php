...
<div class="container">
    ...
    <h4 class="text-center mb-4 h4">Magazine</h4>
    ...
    <div class="d-flex justify-content-center">
        ...
        <div class="column">
            ...
            <div class="row text-right">
                ...
                $reports = [
                    'student' => [
                        ['year' => '2023-24', 'file' => 'magazine_2024.pdf'],
                        ['year' => '2022-23', 'file' => 'magazine_2023.pdf'],
                        ['year' => '2021-22', 'file' => 'magazine_2022.pdf'],
                        ['year' => '2024-25', 'file' => 'magazine_2025.pdf'],
                    ],
                ];
                ...
                function generateReportItems($reports) {
                    foreach ($reports as $index => $report): ?>
                        <div class="col-12 report-item" onclick="window.open('/required/uploads/magazine/<?php echo $report['file']; ?>', '_blank')">
                            <div class="serial-number"><?php echo $index + 1; ?>.</div>
                            <div class="report-content">
                                <a href="/required/uploads/magazine/<?php echo $report['file']; ?>" target="_blank"><?php echo $report['year']; ?></a>
                            </div>
                        </div>
                    <?php endforeach;
                }
