...
if ($reportFormat === 'pdf') {
    ...
    $pdf->Cell(0, 10, "$testDetails->testname - Year Analysis", 0, 1, 'C');
    ...
    $pdf->Cell(20, 10, "Appeared", 1, 0, 'C');
    $pdf->Cell(20, 10, "Pass", 1, 0, 'C');
    $pdf->Cell(20, 10, "Fail", 1, 0, 'C');
    $pdf->Cell(20, 10, "Pass %", 1, 0, 'C');
    $pdf->Ln();
    ...
    foreach ($overall as $subject_code) {
        ...
        $pdf->SetX(15); // Set the starting X position for centering
        $pdf->Cell(20, 10, $subject_code['Subject Code'], 1, 0, 'C');
        $pdf->Cell(75, 10, $subject_code['Subject Name'], 1, 0, 'L');
        $pdf->Cell(20, 10, $subject_code['Total Appeared Students'], 1, 0, 'C');
        $pdf->Cell(20, 10, $subject_code['Total Pass Count'], 1, 0, 'C');
        $pdf->Cell(20, 10, $subject_code['Total Fail Count'], 1, 0, 'C');
        $pdf->Cell(20, 10, $subject_code['Pass Percentage'], 1, 0, 'C');
        $pdf->Ln();
    }
    ...
    $pdf->SetFont('helvetica', 'B', 14); // Larger font for title
    $pdf->Cell(0, 10, "$testDetails->testname - Classwise Analysis", 0, 1, 'C');
